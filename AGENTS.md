...
- `.codemd/repo_stats.json` for lightweight repository facts.
- `.codemd/repo_text.json` for extracted README, docs, and UI text.
...
- Avoid relying on `.codemd/repo_comments.json` unless comment extraction has been cleaned up.
