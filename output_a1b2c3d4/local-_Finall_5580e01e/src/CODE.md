...
Generated for local-upload/FinallyDoneApp-0d95d8e7 from direct repository evidence only. No LLM summaries, feature catalog, embeddings, vectors, train pairs, or model-layer files are used.
...
| tasksChat__pending_states | 3 | 0 | 3 |
| tasksChat__get_current_user | 2 | 2 | 4 |
| tasksChat__users_by_id | 2 | 0 | 2 |
...
| tasksChat__get_current_user | 4 | 2 | 2 |
| tasksChat__oauth_callback | 4 | 0 | 4 |
| tasksChat.get_valid_google_token | 3 | 1 | 2 |
| tasksChat.oauth_start | 3 | 1 | 2 |
| tasksChat__create_user_with_google_tokens | 3 | 1 | 2 |
| tasksChat__get_valid_google_token | 3 | 1 | 2 |
| tasksChat__oauth_start | 3 | 0 | 3 |
| tasksChat__oauth_token | 3 | 0 | 3 |
| tasksChat__pending_states | 3 | 3 | 0 |
...
| tasksChat__create_user_with_google_tokens | 2 | 1 | 3 |
| tasksChat__debug_pending_states | 2 | 0 | 2 |
| tasksChat__get_current_user | 2 | 2 | 4 |
