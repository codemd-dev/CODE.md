...
Generated for local-path/vscode-extension-graphs-4e0db6a0 from direct repository evidence only. No LLM summaries, feature catalog, embeddings, vectors, train pairs, or model-layer files are used.
...
| POST | /mixpanel/connect | mixpanel_connect | backend/main.py | 9746 |
| GET | /mixpanel/connection-status | mixpanel_connection_status | backend/main.py | 9803 |
| POST | /mixpanel/load-user-activity | mixpanel_load_user_activity | backend/main.py | 9933 |
| POST | /sentry/connect | sentry_connect | backend/main.py | 10064 |
| POST | /sentry/load-errors | sentry_load_errors | backend/main.py | 10171 |
| POST | /analytics/map-activity-to-code | analytics_map_activity_to_code | backend/main.py | 10291 |
| GET | /self-healing/ga-errors | self_healing_ga_errors | backend/main.py | 11658 |
| POST | /self-healing/analyze | self_healing_analyze | backend/main.py | 11674 |
| POST | /self-healing/evaluate | self_healing_evaluate | backend/main.py | 11742 |
| POST | /self-healing/apply | self_healing_apply | backend/main.py | 11791 |
| POST | /google-analytics/rebuild-event-traces | google_analytics_rebuild_event_traces | backend/main.py | 12052 |
| POST | /google-analytics/event-callgraph | google_analytics_event_callgraph | backend/main.py | 12057 |
| POST | /mixpanel/event-callgraph | mixpanel_event_callgraph | backend/main.py | 12065 |
| GET | /google-analytics/callgraph-events | google_analytics_callgraph_events | backend/main.py | 12073 |
| POST | /contact | contact | backend/main.py | 12529 |
| POST | /code-notes | add_code_note | backend/main.py | 12563 |
| GET | /todo-targets | todo_targets | backend/main.py | 12762 |
| POST | /user-todos | add_user_todo | backend/main.py | 12847 |
| GET | /user-todos | list_user_todos | backend/main.py | 12946 |
| POST | /user-todos/delete | delete_user_todo | backend/main.py | 12990 |
| POST | /scoped-callgraph | scoped_callgraph | backend/main.py | 13027 |
| GET | /quality-signals | quality_signals | backend/main.py | 15786 |
| POST | /quality-signals/validate | validate_quality_signal | backend/main.py | 16184 |
| POST | /quality-signals/analyze | analyze_quality_signal | backend/main.py | 16251 |
| POST | /quality-signals/evaluate | evaluate_quality_signal_fix | backend/main.py | 16346 |
| POST | /quality-signals/apply | apply_quality_signal_fix | backend/main.py | 16395 |
| POST | /quality-signals/resolve | resolve_quality_signal | backend/main.py | 16416 |
| GET | /unused-functions | list_unused_functions | backend/main.py | 16481 |
| POST | /unused-functions/ack | ack_unused_functions | backend/main.py | 16544 |
| POST | /search | search | backend/main.py | 25268 |
| POST | /search-result-graph | search_result_graph | backend/main.py | 26285 |
| GET | /function-summaries | function_summaries | backend/main.py | 26359 |
| POST | /searchOLD | search | backend/main.py | 26378 |
| POST | /search-answer | search_answer | backend/main.py | 26690 |
| POST | /search-answer-feedback | search_answer_feedback | backend/main.py | 26761 |
| POST | /product-feature-metadata | product_feature_metadata | backend/main.py | 27522 |
| POST | /feature-summary | feature_summary | backend/main.py | 27575 |
| POST | /summary | summary | backend/main.py | 27776 |
| POST | /code-md | code_md_endpoint | backend/main.py | 33851 |
| POST | /analyze/start | analyze_start | backend/main.py | 34927 |
| POST | /playwright/start | playwright_start | backend/main.py | 34960 |
| GET | /playwright/status/{job_id} | playwright_status | backend/main.py | 34987 |
| GET | /analyze/status/{job_id} | analyze_status | backend/main.py | 34995 |
| POST | /analyze | analyze_repo | backend/main.py | 35070 |
| POST | /analyze/upload | analyze_upload | backend/main.py | 35194 |
| POST | /analyze/local_path | analyze_local_path | backend/main.py | 35284 |
| POST | /analyze/local_path/start | analyze_local_path_start | backend/main.py | 35328 |
...
| backend/static/BACKUP/dash.html | backend/static/dashboard.html | onclick handler, event handler, inferred call |
...
| backend/static/BACKUP/dashboardv1.html | backend/static/dashboard.html | event handler, onclick handler, inferred call |
...
| backend/main.py | 9790 | upsert | mixpanel_connect | 0 | lambda: client.table("codeval_mixpanel_connections").upsert(row, on_conflict="owner_name,repo_name").execute(), |
| backend/main.py | 10103 | upsert | sentry_connect | 0 | lambda: client.table("codeval_sentry_connections").upsert(row, on_conflict="owner_name,repo_name").execute(), |
| backend/main.py | 10238 | upsert | sentry_load_errors | 0 | .upsert(rows, on_conflict="issue_id") |
| backend/main.py | 10350 | update | analytics_map_activity_to_code | 0 | .update({"mapped": True}) |
| backend/main.py | 12910 | insert | add_user_todo | 0 | lambda: client.table("codeval_todos").insert(todo_row).execute(), |
| backend/main.py | 13006 | delete | delete_user_todo | 0 | .delete() |
| backend/main.py | 16445 | update | resolve_quality_signal | 0 | .update(update_payload) |
| backend/main.py | 16462 | update | resolve_quality_signal | 0 | row[0].update(update_payload) |
| backend/main.py | 16466 | upsert | resolve_quality_signal | 0 | .upsert(row[0], on_conflict="analysis_run_id,finding_id") |
| backend/main.py | 34850 | update | run_analyze_job | 0 | results.update(dispatch_parsers( |
| backend/main.py | 34867 | update | run_analyze_job | 0 | results.update(build_scim_artifacts( |
...
| scim | 4 | backend/main.py:10527, backend/main.py:23376, backend/main.py:30914, backend/main.py:31027 |
| pyvis | 3 | backend/main.py:68, backend/main.py:19245, backend/main.py:19001 |
...
| javalang | 2 | backend/main.py:72, backend/main.py:28575 |
| parsers | 2 | backend/main.py:113, backend/main.py:28333 |
| cryptography | 2 | backend/main.py:9686, backend/main.py:9691 |
| tree_sitter | 2 | backend/main.py:28836, backend/main.py:29321 |
| sentry_sdk | 2 | backend/main.py:485, backend/main.py:486 |
| supabase | 2 | backend/main.py:1896, backend/supabase_client.py:4 |
| numpy | 2 | backend/main.py:23375, backend/scim.py:41 |
| torch | 2 | backend/scim.py:54, backend/scim.py:55 |
| requests | 1 | backend/main.py:56 |
| playwright | 1 | backend/main.py:774 |
| tree_sitter_java | 1 | backend/main.py:28837 |
| tree_sitter_javascript | 1 | backend/main.py:29343 |
| supabase_client | 1 | backend/main.py:1878 |
| jwt | 1 | backend/main.py:4061 |
| tree_sitter_typescript | 1 | backend/main.py:29335 |
| pyparsing | 1 | backend/parsers/python/pyan3_parser.py:4 |
| pyan | 1 | backend/parsers/python/pyan3_parser.py:52 |
| _ast_unparse | 1 | backend/parsers/python/pycg_parser.py:15 |
...
| os | 1 | src/extension.ts:4 |
| crypto | 1 | src/extension.ts:5 |
| child_process | 1 | src/extension.ts:6 |
